...
user.org:user:axis_cic_v1:1.0\
xilinx.com:ip:axis_clock_converter:1.1\
xilinx.com:ip:axis_combiner:1.1\
user.org:user:axis_dds_dual_v1:1.0\
user.org:user:axis_filter_v1:1.0\
user.org:user:axis_pfb_4x1024_v1:1.0\
user.org:user:axis_pfba_pr_4x256_v1:1.0\
user.org:user:axis_pfbsynth_4x1024_v1:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axis_chsel_0, and set properties
  set axis_chsel_0 [ create_bd_cell -type ip -vlnv user.org:user:axis_chsel_pfb_v2:1.0 axis_chsel_0 ]
  set_property -dict [ list \
   CONFIG.B {32} \
   CONFIG.NCH {1024} \
 ] $axis_chsel_0
  ...
  set axis_cic_0 [ create_bd_cell -type ip -vlnv user.org:user:axis_cic_v1:1.0 axis_cic_0 ]
  set_property -dict [ list \
   CONFIG.L {8} \
   CONFIG.NCH {128} \
 ] $axis_cic_0
  ...
  # Create instance: axis_dds_dual_0, and set properties
  set axis_dds_dual_0 [ create_bd_cell -type ip -vlnv user.org:user:axis_dds_dual_v1:1.0 axis_dds_dual_0 ]
  set_property -dict [ list \
   CONFIG.L {8} \
   CONFIG.NCH {128} \
 ] $axis_dds_dual_0

  # Create instance: axis_filter_v1_0, and set properties
  set axis_filter_v1_0 [ create_bd_cell -type ip -vlnv user.org:user:axis_filter_v1:1.0 axis_filter_v1_0 ]
  ...
  # Create instance: axis_pfb_in_pr_0, and set properties
  set axis_pfb_in_pr_0 [ create_bd_cell -type ip -vlnv user.org:user:axis_pfba_pr_4x256_v1:1.0 axis_pfb_in_pr_0 ]

  # Create instance: axis_pfb_out_0, and set properties
  set axis_pfb_out_0 [ create_bd_cell -type ip -vlnv user.org:user:axis_pfbsynth_4x1024_v1:1.0 axis_pfb_out_0 ]

  # Create instance: axis_pfb_out_pr_0, and set properties
  set axis_pfb_out_pr_0 [ create_bd_cell -type ip -vlnv user.org:user:axis_pfbs_pr_4x256_v1:1.0 axis_pfb_out_pr_0 ]
  ...
  # Create instance: axis_streamer_0, and set properties
  set axis_streamer_0 [ create_bd_cell -type ip -vlnv user.org:user:axis_streamer_v1:1.0 axis_streamer_0 ]
  set_property -dict [ list \
   CONFIG.BAXIS {512} \
   CONFIG.BDATA {256} \
   CONFIG.BUSER {16} \
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_intf_net -intf_net axis_chsel_pfb_v2_0_m_axis [get_bd_intf_pins axis_chsel_0/m_axis] [get_bd_intf_pins axis_streamer_0/s_axis]
  connect_bd_intf_net -intf_net axis_cic_v1_0_m_axis [get_bd_intf_pins axis_chsel_0/s_axis] [get_bd_intf_pins axis_cic_0/m_axis]
  connect_bd_intf_net -intf_net axis_clock_converter_0_M_AXIS [get_bd_intf_pins axis_clock_converter_0/M_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/s00_axis]
  connect_bd_intf_net -intf_net axis_clock_converter_1_M_AXIS [get_bd_intf_pins axis_clock_converter_1/M_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/s20_axis]
  ...
  connect_bd_intf_net -intf_net axis_dds_dual_v1_0_m0_axis [get_bd_intf_pins axis_dds_dual_0/m0_axis] [get_bd_intf_pins axis_pfb_out_0/s_axis]
  connect_bd_intf_net -intf_net axis_dds_dual_v1_0_m1_axis [get_bd_intf_pins axis_cic_0/s_axis] [get_bd_intf_pins axis_dds_dual_0/m1_axis]
  connect_bd_intf_net -intf_net axis_filter_v1_0_m_axis [get_bd_intf_pins axis_filter_v1_0/m_axis] [get_bd_intf_pins axis_pfb_out_pr_0/s_axis]
  connect_bd_intf_net -intf_net axis_pfb_4x1024_v1_0_m_axis [get_bd_intf_pins axis_dds_dual_0/s0_axis] [get_bd_intf_pins axis_pfb_in_0/m_axis]
  connect_bd_intf_net -intf_net axis_pfb_in_pr_0_m_axis [get_bd_intf_pins axis_filter_v1_0/s_axis] [get_bd_intf_pins axis_pfb_in_pr_0/m_axis]
  connect_bd_intf_net -intf_net axis_pfb_out_0_m_axis [get_bd_intf_pins axis_clock_converter_0/S_AXIS] [get_bd_intf_pins axis_pfb_out_0/m_axis]
  connect_bd_intf_net -intf_net axis_pfb_out_pr_0_m_axis [get_bd_intf_pins axis_clock_converter_1/S_AXIS] [get_bd_intf_pins axis_pfb_out_pr_0/m_axis]
  connect_bd_intf_net -intf_net axis_reorder_iq_v1_0_m_axis [get_bd_intf_pins axis_pfb_in_0/s_axis] [get_bd_intf_pins axis_reorder_iq_v1_0/m_axis]
  connect_bd_intf_net -intf_net axis_reorder_iq_v1_1_m_axis [get_bd_intf_pins axis_pfb_in_pr_0/s_axis] [get_bd_intf_pins axis_reorder_iq_v1_1/m_axis]
  connect_bd_intf_net -intf_net axis_streamer_v1_0_m_axis [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins axis_streamer_0/m_axis]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins axis_chsel_0/s_axi] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins axis_cic_0/s_axi] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins axis_dds_dual_0/s_axi] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins axis_filter_v1_0/s_axi] [get_bd_intf_pins ps8_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins axis_pfb_in_0/s_axi] [get_bd_intf_pins ps8_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M06_AXI [get_bd_intf_pins axis_pfb_in_pr_0/s_axi] [get_bd_intf_pins ps8_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M07_AXI [get_bd_intf_pins axis_pfb_out_pr_0/s_axi] [get_bd_intf_pins ps8_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M08_AXI [get_bd_intf_pins axis_pfb_out_0/s_axi] [get_bd_intf_pins ps8_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M09_AXI [get_bd_intf_pins axis_streamer_0/s_axi] [get_bd_intf_pins ps8_0_axi_periph/M09_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M10_AXI [get_bd_intf_pins ps8_0_axi_periph/M10_AXI] [get_bd_intf_pins usp_rf_data_converter_0/s_axi]
  ...
  connect_bd_net -net rst_adc0_peripheral_aresetn [get_bd_pins axis_chsel_0/aresetn] [get_bd_pins axis_cic_0/aresetn] [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins axis_clock_converter_1/s_axis_aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_combiner_1/aresetn] [get_bd_pins axis_dds_dual_0/aresetn] [get_bd_pins axis_filter_v1_0/aresetn] [get_bd_pins axis_pfb_in_0/aresetn] [get_bd_pins axis_pfb_in_pr_0/aresetn] [get_bd_pins axis_pfb_out_0/aresetn] [get_bd_pins axis_pfb_out_pr_0/aresetn] [get_bd_pins axis_reorder_iq_v1_0/aresetn] [get_bd_pins axis_reorder_iq_v1_1/aresetn] [get_bd_pins axis_streamer_0/s_axis_aresetn] [get_bd_pins rst_adc0/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/m0_axis_aresetn]
  connect_bd_net -net rst_dac0_peripheral_aresetn [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins rst_dac0/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s0_axis_aresetn]
  connect_bd_net -net rst_dac2_peripheral_aresetn [get_bd_pins axis_clock_converter_1/m_axis_aresetn] [get_bd_pins rst_dac2/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s2_axis_aresetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_chsel_0/s_axi_aresetn] [get_bd_pins axis_cic_0/s_axi_aresetn] [get_bd_pins axis_dds_dual_0/s_axi_aresetn] [get_bd_pins axis_filter_v1_0/s_axi_aresetn] [get_bd_pins axis_pfb_in_0/s_axi_aresetn] [get_bd_pins axis_pfb_in_pr_0/s_axi_aresetn] [get_bd_pins axis_pfb_out_0/s_axi_aresetn] [get_bd_pins axis_pfb_out_pr_0/s_axi_aresetn] [get_bd_pins axis_streamer_0/m_axis_aresetn] [get_bd_pins axis_streamer_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins ps8_0_axi_periph/M08_ARESETN] [get_bd_pins ps8_0_axi_periph/M09_ARESETN] [get_bd_pins ps8_0_axi_periph/M10_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_100/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
  connect_bd_net -net usp_rf_data_converter_0_clk_adc0 [get_bd_pins axis_chsel_0/aclk] [get_bd_pins axis_cic_0/aclk] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins axis_clock_converter_1/s_axis_aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_combiner_1/aclk] [get_bd_pins axis_dds_dual_0/aclk] [get_bd_pins axis_filter_v1_0/aclk] [get_bd_pins axis_pfb_in_0/aclk] [get_bd_pins axis_pfb_in_pr_0/aclk] [get_bd_pins axis_pfb_out_0/aclk] [get_bd_pins axis_pfb_out_pr_0/aclk] [get_bd_pins axis_reorder_iq_v1_0/aclk] [get_bd_pins axis_reorder_iq_v1_1/aclk] [get_bd_pins axis_streamer_0/s_axis_aclk] [get_bd_pins rst_adc0/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/clk_adc0] [get_bd_pins usp_rf_data_converter_0/m0_axis_aclk]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac0 [get_bd_pins axis_clock_converter_0/m_axis_aclk] [get_bd_pins rst_dac0/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/clk_dac0] [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac2 [get_bd_pins axis_clock_converter_1/m_axis_aclk] [get_bd_pins rst_dac2/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/clk_dac2] [get_bd_pins usp_rf_data_converter_0/s2_axis_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_chsel_0/s_axi_aclk] [get_bd_pins axis_cic_0/s_axi_aclk] [get_bd_pins axis_dds_dual_0/s_axi_aclk] [get_bd_pins axis_filter_v1_0/s_axi_aclk] [get_bd_pins axis_pfb_in_0/s_axi_aclk] [get_bd_pins axis_pfb_in_pr_0/s_axi_aclk] [get_bd_pins axis_pfb_out_0/s_axi_aclk] [get_bd_pins axis_pfb_out_pr_0/s_axi_aclk] [get_bd_pins axis_streamer_0/m_axis_aclk] [get_bd_pins axis_streamer_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins ps8_0_axi_periph/M06_ACLK] [get_bd_pins ps8_0_axi_periph/M07_ACLK] [get_bd_pins ps8_0_axi_periph/M08_ACLK] [get_bd_pins ps8_0_axi_periph/M09_ACLK] [get_bd_pins ps8_0_axi_periph/M10_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_100/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins rst_100/ext_reset_in] [get_bd_pins rst_adc0/ext_reset_in] [get_bd_pins rst_dac0/ext_reset_in] [get_bd_pins rst_dac2/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_chsel_0/s_axi/reg0] -force
  assign_bd_address -offset 0xA0020000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_cic_0/s_axi/reg0] -force
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_dds_dual_0/s_axi/reg0] -force
  assign_bd_address -offset 0xA0024000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_filter_v1_0/s_axi/reg0] -force
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_pfb_in_0/s_axi/reg0] -force
  assign_bd_address -offset 0xA0021000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_pfb_in_pr_0/s_axi/reg0] -force
  assign_bd_address -offset 0xA0023000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_pfb_out_0/s_axi/reg0] -force
  assign_bd_address -offset 0xA0022000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_pfb_out_pr_0/s_axi/reg0] -force
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axis_streamer_0/s_axi/reg0] -force
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.276316",
   "Default View_TopLeft":"-662,-1031",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port adc0_clk -pg 1 -lvl 0 -x -140 -y 930 -defaultsOSRD
preplace port dac0_clk -pg 1 -lvl 0 -x -140 -y 950 -defaultsOSRD
preplace port dac2_clk -pg 1 -lvl 0 -x -140 -y 970 -defaultsOSRD
preplace port sysref_in -pg 1 -lvl 0 -x -140 -y 1030 -defaultsOSRD
preplace port vin0_01 -pg 1 -lvl 0 -x -140 -y 990 -defaultsOSRD
preplace port vin0_23 -pg 1 -lvl 0 -x -140 -y 1010 -defaultsOSRD
preplace port vout00 -pg 1 -lvl 12 -x 4090 -y 1020 -defaultsOSRD
preplace port vout20 -pg 1 -lvl 12 -x 4090 -y 1040 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 11 -x 3890 -y 480 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 490 -y -740 -defaultsOSRD
preplace inst axis_chsel_0 -pg 1 -lvl 9 -x 3250 -y 470 -defaultsOSRD
preplace inst axis_cic_0 -pg 1 -lvl 8 -x 2950 -y 470 -defaultsOSRD
preplace inst axis_clock_converter_0 -pg 1 -lvl 2 -x 490 -y 580 -defaultsOSRD
preplace inst axis_clock_converter_1 -pg 1 -lvl 2 -x 490 -y 770 -defaultsOSRD -resize 220 156
preplace inst axis_combiner_0 -pg 1 -lvl 4 -x 1680 -y 490 -defaultsOSRD
preplace inst axis_combiner_1 -pg 1 -lvl 4 -x 1680 -y 710 -defaultsOSRD -resize 280 136
preplace inst axis_dds_dual_0 -pg 1 -lvl 7 -x 2630 -y 470 -defaultsOSRD
preplace inst axis_pfb_in_0 -pg 1 -lvl 6 -x 2320 -y 470 -defaultsOSRD
preplace inst axis_pfb_in_pr_0 -pg 1 -lvl 6 -x 2320 -y 690 -defaultsOSRD
preplace inst axis_pfb_out_0 -pg 1 -lvl 1 -x 60 -y 540 -defaultsOSRD
preplace inst axis_pfb_out_pr_0 -pg 1 -lvl 8 -x 2950 -y 690 -defaultsOSRD
preplace inst axis_reorder_iq_v1_0 -pg 1 -lvl 5 -x 2030 -y 500 -defaultsOSRD
preplace inst axis_reorder_iq_v1_1 -pg 1 -lvl 5 -x 2030 -y 720 -defaultsOSRD -resize 180 116
preplace inst axis_streamer_0 -pg 1 -lvl 10 -x 3550 -y 450 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 4 -x 1680 -y -710 -defaultsOSRD
preplace inst rst_100 -pg 1 -lvl 3 -x 1140 -y -530 -defaultsOSRD
preplace inst rst_adc0 -pg 1 -lvl 3 -x 1140 -y -350 -defaultsOSRD
preplace inst rst_dac0 -pg 1 -lvl 3 -x 1140 -y -140 -defaultsOSRD -resize 320 156
preplace inst rst_dac2 -pg 1 -lvl 3 -x 1140 -y 70 -defaultsOSRD -resize 320 156
preplace inst usp_rf_data_converter_0 -pg 1 -lvl 3 -x 1140 -y 1030 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 3 -x 1140 -y -730 -defaultsOSRD
preplace inst axis_filter_v1_0 -pg 1 -lvl 7 -x 2630 -y 690 -defaultsOSRD
preplace netloc rst_adc0_peripheral_aresetn 1 0 10 -100 650 180 870 710 740 1470J 390 1880 390 2180 350 2460J 350 2780 350 3090 350 3390
preplace netloc rst_dac0_peripheral_aresetn 1 1 3 200 910 630 570 1440
preplace netloc rst_dac2_peripheral_aresetn 1 1 3 210 920 690 580 1430
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 0 11 -110 340 190 340 650 340 1500 340 N 340 2170 340 2490 340 2810 340 3120 340 3410 320 3670
preplace netloc usp_rf_data_converter_0_clk_adc0 1 0 10 -90 660 190 880 670 400 1450 400 1840 400 2190 360 2440 360 2760 360 3080 360 3370
preplace netloc usp_rf_data_converter_0_clk_dac0 1 1 3 220 890 660 800 1440
preplace netloc usp_rf_data_converter_0_clk_dac2 1 1 3 230 900 620 810 1430
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 11 -120 -660 180 -660 700 -250 1480 -250 N -250 2140 330 2510 330 2830 320 3130 320 3380 310 3690
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 2 2 720 -630 1470
preplace netloc adc0_clk_1 1 0 3 N 930 N 930 N
preplace netloc axi_dma_0_M_AXI_S2MM 1 1 11 210 230 N 230 N 230 N 230 N 230 N 230 N 230 N 230 N 230 N 230 4050
preplace netloc axi_smc_M00_AXI 1 2 1 620 -770n
preplace netloc axis_chsel_pfb_v2_0_m_axis 1 9 1 3400 380n
preplace netloc axis_cic_v1_0_m_axis 1 8 1 3110 420n
preplace netloc axis_clock_converter_0_M_AXIS 1 2 1 680 580n
preplace netloc axis_clock_converter_1_M_AXIS 1 2 1 640 770n
preplace netloc axis_combiner_0_M_AXIS 1 4 1 1850 480n
preplace netloc axis_combiner_1_M_AXIS 1 4 1 1900 700n
preplace netloc axis_dds_dual_v1_0_m0_axis 1 0 8 -100 310 N 310 N 310 N 310 N 310 N 310 N 310 2750
preplace netloc axis_dds_dual_v1_0_m1_axis 1 7 1 2790 420n
preplace netloc axis_filter_v1_0_m_axis 1 7 1 2820 640n
preplace netloc axis_pfb_4x1024_v1_0_m_axis 1 6 1 2470 420n
preplace netloc axis_pfb_in_pr_0_m_axis 1 6 1 2500 640n
preplace netloc axis_pfb_out_0_m_axis 1 1 1 N 540
preplace netloc axis_pfb_out_pr_0_m_axis 1 1 8 210 320 N 320 N 320 N 320 N 320 N 320 2780 330 3070
preplace netloc axis_reorder_iq_v1_0_m_axis 1 5 1 2150 420n
preplace netloc axis_reorder_iq_v1_1_m_axis 1 5 1 2150 640n
preplace netloc axis_streamer_v1_0_m_axis 1 10 1 3680 450n
preplace netloc dac0_clk_1 1 0 3 N 950 N 950 N
preplace netloc dac2_clk_1 1 0 3 N 970 N 970 N
preplace netloc ps8_0_axi_periph_M00_AXI 1 4 7 1900 -740 NJ -740 NJ -740 NJ -740 NJ -740 NJ -740 3700J
preplace netloc ps8_0_axi_periph_M01_AXI 1 4 5 1890 -730 NJ -730 NJ -730 NJ -730 3100J
preplace netloc ps8_0_axi_periph_M02_AXI 1 4 4 1880 -720 NJ -720 NJ -720 2800J
preplace netloc ps8_0_axi_periph_M03_AXI 1 4 3 1870 -710 NJ -710 2480J
preplace netloc ps8_0_axi_periph_M04_AXI 1 4 3 1860J -700 NJ -700 2450
preplace netloc ps8_0_axi_periph_M05_AXI 1 4 2 1850J -690 2200
preplace netloc ps8_0_axi_periph_M06_AXI 1 4 2 1840J -680 2160
preplace netloc ps8_0_axi_periph_M07_AXI 1 4 4 NJ -670 NJ -670 NJ -670 2770
preplace netloc ps8_0_axi_periph_M08_AXI 1 0 5 -90 370 NJ 370 N 370 NJ 370 1880
preplace netloc ps8_0_axi_periph_M09_AXI 1 4 6 NJ -630 NJ -630 NJ -630 NJ -630 NJ -630 3420
preplace netloc ps8_0_axi_periph_M10_AXI 1 2 3 720 330 NJ 330 1850
preplace netloc sysref_in_1 1 0 3 NJ 1030 N 1030 N
preplace netloc usp_rf_data_converter_0_m00_axis 1 3 1 1460 460n
preplace netloc usp_rf_data_converter_0_m01_axis 1 3 1 1480 480n
preplace netloc usp_rf_data_converter_0_m02_axis 1 3 1 1490 680n
preplace netloc usp_rf_data_converter_0_m03_axis 1 3 1 1500 700n
preplace netloc usp_rf_data_converter_0_vout00 1 3 9 N 1020 N 1020 N 1020 N 1020 N 1020 N 1020 N 1020 N 1020 N
preplace netloc usp_rf_data_converter_0_vout20 1 3 9 N 1040 N 1040 N 1040 N 1040 N 1040 N 1040 N 1040 N 1040 N
preplace netloc vin0_01_1 1 0 3 N 990 N 990 N
preplace netloc vin0_23_1 1 0 3 N 1010 N 1010 N
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 3 1 1470 -970n
levelinfo -pg 1 -140 60 490 1140 1680 2030 2320 2630 2950 3250 3550 3890 4090
pagesize -pg 1 -db -bbox -sgen -260 -1480 4190 1250
"
}
